...
namespace FileRecord.Utils
{
    ...
    public static class FileFilterRuleFactory
    {
        ...
        /// <param name="name">????</param>
        public static FileFilterRule CreateCharacterInNameRule(char character, string name = "??????")
        {
            // ?????: .*??.*\..*  ?????????????????
        ...
        /// ????????????? *a.* ?????????? a ?????????
        /// </summary>
        /// <param name="wildcardPattern">??????? *a.* </param>
        /// <param name="name">????</param>
        public static FileFilterRule CreateWildcardRule(string wildcardPattern, string name = "?????")
        {
            // ??????????????
        ...
        /// ??????????????
        /// </summary>
        /// <param name="wildcard">??????? *a.*, *.txt ??</param>
        /// <returns>????????</returns>
